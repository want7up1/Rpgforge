...
- **角色真的会成长。** 经验、能力、技能熟练度、状态、任务、待解的剧情线索，都作为真实游戏状态被记录，而不只是花哨的描述文字。
- **NPC 会记住你。** 关系随你的实际行为变化，世界会替你记账。
- **剧情不会跑偏。** 幕后有"故事导演"和"漂移校验"两层，确保每一回合都忠于你最初设定的世界与规则——AI 不会悄悄忘了剧情。
...
每次 LLM 调用（故事导演、GM、漂移校验、状态抽取、上下文压缩、judge、生成器）都会连同完整的
